...
function Grid() {
  ...
  useEffect(() => {
    animate(
      "rect",
      { opacity: [0], pathLength: [0, 1], color: "red" },
      { duration: 5, repeat: Infinity, repeatType: "mirror" }
    );
    animate(
      "rect",
      { opacity: [0.07], pathLength: [0, 1], color: "red" },
      { duration: 5, repeat: Infinity, repeatType: "mirror" }
    );
    animate(
      "circle",
      { opacity: [0.07], pathLength: [0, 1] },
      { duration: 5, repeat: Infinity, repeatType: "mirror" }
    );
  }, []);
  return (
    <div className="fixed">
      <svg
        ...
        width="800"
        height="800">
        <g stroke-width="3.5" stroke="hsl(261, 60%, 38%)" fill="none">
          <rect
